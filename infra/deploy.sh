...
# Automatisiert sauberes Setup der kompletten Infrastruktur ohne Bucket-Konflikte
...
# 1. Smart Bootstrap - nur wenn nötig
echo -e "${YELLOW}📋 Step 1: Smart Bootstrap Strategy${NC}"

cd terraform/bootstrap

# Prüfen welche Ressourcen fehlen
...
if [[ "$DEV_BUCKET_EXISTS" == true && "$DEV_TABLE_EXISTS" == true ]]; then
    ...
    # Nur fehlende Ressourcen erstellen
